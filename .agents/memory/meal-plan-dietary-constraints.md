...
**How to apply:** rilevare e richiedere il consenso salute prima di qualsiasi invio all'AI; estrarre solo note sanitarie interpretabili in modo deterministico e rifiutare quelle ambigue; validare l'output completo prima dello streaming e applicare lo stesso controllo a ogni percorso di persistenza. I prompt devono sostituire, non solo contraddire, qualunque esempio o tema incompatibile con un vincolo noto. Se il primo risultato AI è incompatibile, rigenerare l'intero piano con un numero fisso di tentativi e istruzioni correttive; solo l'errore terminale può arrivare al client, in forma contestuale e non bloccante. Durante l'attesa si possono inviare soltanto stati fissi del server, mai contenuti del piano non validati.
