...
- Se una risposta HTTP contraddice il sorgente anche dopo un restart, controllare che esista una sola istanza backend.
- **Why:** un restart può lasciare un processo server orfano; due istanze concorrenti fanno alternare shell e bundle vecchi/nuovi e producono errori di hydration apparentemente casuali.
- **How to apply:** fermare completamente il workflow, verificare processi e porta 5000, terminare gli orfani e avviare una sola istanza gestita prima di continuare il debug.
