...
**How to apply:** mantenere il tetto di 4.800 token con titoli e descrizioni minimi, esattamente tre ingredienti essenziali e tre passaggi brevi. Le liste alimentari chiuse vanno espresse nel prompt e validate fail-closed dal server prima della consegna o del salvataggio, non replicate come enum in tutti i 21 slot.