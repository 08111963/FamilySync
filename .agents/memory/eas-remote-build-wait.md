...
**How to apply:** dopo l'upload, acquisire l'ID EAS e interrogare periodicamente `eas build:view <id> --json` fino a `FINISHED`, `ERRORED` o `CANCELED`; non terminare il processo CLI che usa l'attesa integrata.