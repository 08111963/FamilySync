...
export const PLAN_LIMITS: Record<Plan, Record<AiFeature, FeatureLimit>> = {
  ...
  premium: {
    ...
    "recipe-search": { max: 10, window: "day" },
    "recipe-suggestions": { max: 5, window: "day" },
    "weekly-meal-plan": { max: 3, window: "week" },
    insights: { max: 5, window: "week" },
    "chore-optimization": { max: 5, window: "day" },
    "voice-transcription": { max: 20, window: "day" },
