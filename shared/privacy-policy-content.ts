...
export const PRIVACY_POLICY_SECTIONS: PolicySection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      li("**Registro delle accettazioni:** data e versione dei Termini d'Uso accettati"),
  ...
  },
  {
    ...
    blocks: [
      ...
      li("**Ricette e piani pasti:** preferenze alimentari indicate, eventuali note libere sui pasti, ingredienti disponibili in dispensa, titoli e descrizioni delle ricette. Le **allergie e intolleranze** che indichi vengono incluse per mantenere i suggerimenti compatibili con tali vincoli"),
      ...
      li("**Assistente Home:** il testo libero che detti o scrivi all'assistente per aggiungere più elementi insieme (eventi, faccende, articoli della spesa, bollette, premi, pasti). Vengono inviati il testo così come lo scrivi o lo detti e i soprannomi dei membri della famiglia, per riconoscere gli assegnatari citati. Nulla viene creato senza la tua conferma esplicita sul riepilogo proposto"),
  ...
  },
  {
    ...
    blocks: [
      ...
      li("**OpenAI:** funzioni AI e trascrizione vocale, con i soli dati minimizzati necessari alla funzione richiesta"),
  ...
  },
  {
    ...
    blocks: [
      ...
      li("**Revoca dei collegamenti facoltativi:** scollegare in qualsiasi momento servizi opzionali collegati all'account, come Google Calendar, senza pregiudicare la liceità del trattamento precedente"),
