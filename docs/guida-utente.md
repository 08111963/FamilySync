...
6. [Gestione Famiglia](#6-gestione-famiglia)
7. [Suggerimenti AI](#7-suggerimenti-ai)
8. [Sicurezza e Moderazione](#8-sicurezza-e-moderazione)
9. [Impostazioni e Account](#9-impostazioni-e-account)
10. [Sincronizzazione in Tempo Reale](#10-sincronizzazione-in-tempo-reale)
11. [Domande Frequenti (FAQ)](#11-domande-frequenti-faq)
...
- Il familiare ricevera un link di invito che potra usare per unirsi al gruppo
- Puoi assegnare un **soprannome** e un **colore** a ciascun membro
...
- **Membro**: puo utilizzare tutte le funzionalita di calendario, spesa e faccende

### Invitare Nuovi Membri
- Tocca il pulsante di aggiunta membro nella scheda Famiglia
- Inserisci l'email della persona da invitare
- Puoi specificare il ruolo (membro o admin)
- Il link di invito puo essere condiviso anche tramite altre app
...
2. **Ottimizzazione Faccende**: distribuzione equa delle faccende tra i membri
3. **Insights Familiari**: statistiche e consigli sulla gestione della famiglia
...
## 10. Sincronizzazione in Tempo Reale

FamilySync sincronizza automaticamente tutti i dati tra i dispositivi dei membri della famiglia.

### Come Funziona
- Quando un membro aggiunge un evento, un articolo alla spesa o completa una faccenda, **tutti i dispositivi** collegati vengono aggiornati istantaneamente
