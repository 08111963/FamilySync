...
L'app ha 7 schede principali in fondo allo schermo:
...
| Bollette | Tenere traccia di bollette e scadenze, ricevere promemoria, segnare come pagate |
| Chat | Scrivere alla famiglia in tempo reale con testo, foto e documenti |
| Famiglia | Gestire membri, inviti, Premium, impostazioni, AI, documenti legali, assistenza |
...
- [ ] Creare un profilo per ogni bambino sotto i 14 anni e generare il suo codice di accesso: con quello potrà entrare nell'app dal proprio dispositivo
...
6. [Bollette](#6-bollette)
7. [Chat di Famiglia](#7-chat-di-famiglia)
8. [Ricette](#8-ricette)
9. [Piano Pasti Settimanale](#9-piano-pasti-settimanale)
10. [Gestione Famiglia](#10-gestione-famiglia)
11. [Sistema di Inviti](#11-sistema-di-inviti)
12. [Suggerimenti AI](#12-suggerimenti-ai)
13. [Abbonamento Premium](#13-abbonamento-premium)
14. [Sicurezza e Moderazione](#14-sicurezza-e-moderazione)
15. [Impostazioni e Account](#15-impostazioni-e-account)
16. [Contatta Assistenza](#16-contatta-assistenza)
17. [Sincronizzazione in Tempo Reale](#17-sincronizzazione-in-tempo-reale)
...
- Inserisci il tuo nome, indirizzo email e una password sicura (minimo 8 caratteri, con almeno una lettera maiuscola, una minuscola e un numero)
...
La scheda **Bollette** ti aiuta a non dimenticare mai una scadenza e a tenere sotto controllo le spese ricorrenti della famiglia.
...
- Con **Premium** le bollette sono **illimitate** e sblocchi anche:
  - **Allegati**: salva foto delle bollette o documenti PDF (ricevute e documenti)
  - **Ripartizioni**: dividi l'importo tra i membri della famiglia, in parti uguali o personalizzate

### Ripartire una Bolletta (Premium)
Nel dettaglio di una bolletta, con Premium puoi dividere la spesa:
- **Dividi equamente**: l'importo viene suddiviso in parti uguali tra tutti i membri
- **Personalizzata**: inserisci tu la quota di ciascun membro (la somma deve corrispondere all'importo totale)

### Allegati (Premium)
Sempre nel dettaglio, con Premium puoi allegare:
- **Foto** dalla galleria (immagini)
- **Documenti PDF**
...
### Inviare Messaggi
- Apri la scheda **Chat**
- Scrivi nel campo in basso e tocca il pulsante di invio
...
3. Scegli il **Profilo Dieta**: Mediterranea, Vegetariana, Vegana, Senza glutine o Senza lattosio.
...
### Prezzi
- I prezzi vengono mostrati direttamente nella schermata Premium e dipendono dal tuo Paese/store
...
## 14. Sicurezza e Moderazione

FamilySync include strumenti per mantenere un ambiente sicuro e rispettoso.

### Segnalare un Contenuto o un Utente
Se trovi un contenuto inappropriato o vuoi segnalare un comportamento:
- Tocca i tre puntini accanto a un membro nella scheda Famiglia e scegli **Segnala**
...
- **Contatta assistenza**: per scrivere al supporto
...
## 16. Contatta Assistenza

Hai un problema, un dubbio o un suggerimento? Puoi scrivere direttamente al nostro supporto.

### Come Inviare una Richiesta
1. Vai alla scheda **Famiglia**, sezione **Legale**
2. Tocca **Contatta assistenza**
3. Compila il modulo:
   - **Oggetto**: un breve titolo (almeno 3 caratteri)
   - **Messaggio**: descrivi il problema o la domanda (almeno 10 caratteri)
4. Tocca invia
...
## 17. Sincronizzazione in Tempo Reale
...
*Guida aggiornata a giugno 2026 - FamilySync*
