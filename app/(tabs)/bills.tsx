...
const styles = StyleSheet.create({
  ...
  // Mantiene il gruppo delle azioni dentro il bordo anche quando il sottotitolo
  // della sezione scadute è molto lungo.
  headerCopy: { flex: 1, minWidth: 0, paddingRight: 160 },
