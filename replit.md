...
- Quando si modificano funzioni visibili all'utente (ruoli, membri, chat, ecc.): aggiornare SEMPRE anche la guida utente (`docs/guida-utente.md`) e, se toccano dati personali, la privacy policy (`shared/privacy-policy-content.ts`).
