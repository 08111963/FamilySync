...
- Schermata Bollette con distinzione chiara degli stati (app/(tabs)/bills.tsx):
  ...
  - Nuova bolletta con selettore "Stato" (Da pagare / Già pagata): se "Già pagata" il form chiede "Data di pagamento" (default oggi) al posto di "Scadenza" e invia paid:true + paidAt + dueDate=paidDate; il "+" dal filtro Pagate apre /add-bill?paid=1 (preimpostato); in modifica il selettore non compare
